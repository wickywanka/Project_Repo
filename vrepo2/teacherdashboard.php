...
<input type="number" name="year" placeholder="Year upload" required>
              ...
              <input type="text" name="fielda" placeholder="member 1">
              <input type="text" name="fieldb" placeholder="Member 2">
              <input type="text" name="fieldc" placeholder="member 3">
              <input type="text" name="fieldd" placeholder="member 4">
              <input type="text" name="fielde" placeholder="member 5">
